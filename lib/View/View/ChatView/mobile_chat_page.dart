...
class MobileChatPage extends ConsumerStatefulWidget {
  ...
  const MobileChatPage({super.key,required this.data});
                                                        ...
                                                        child: Align(
                                                          ...
                                                          child: Container(
                                                            ...
                                                            child: Column(
                                                              ...
                                                              children: [
                                                                SizedBox(
                                                                  height: keyBoard ? constraints.maxHeight * 0.12 : context.height * 0.12 ,
                                                                  child: Card(
                                                                    color: ConstColor.normalWhite.withOpacity(0.5) ,
                                                                    child: Row(
                                                                      children: [
...
mixin _MobileChatPage {
  final ScrollController _scrollController = ScrollController();
  final TextEditingController _textController = TextEditingController();
  final _visibleProv = ChangeNotifierProvider<SwitchState>((ref)=>SwitchState());
  ...
  AppBar _buildAppBar({
    ...
    return AppBar(
      ...
      actions: [
        Padding(
          padding: const EdgeInsets.all(8.0),
          child: DefaultCircleAvatar(userModel: userModel,color: ConstColor.normalWhite,textColor: ConstColor.lightMainColor,),
        ) ,
      ],
          ...
          return prov.watch(fetchChatProv).when(
              ...
              data: (data)=> AnimatedConditionalBuilder(
                ...
                fallback: (BuildContext buildContext){
                  return ConstGeneral.notFoundData('No There Chat with ${userModel.first} ${userModel.last}');
                },
              )
          );
        }
                                                      ...
                                                      child: Padding(
                                                        ...
                                                        child: Consumer(
                                                          builder:(context,prov,_)=> CustomText(
                                                            text: prov.watch(_checkSubTextProv).value != ConstState.firebaseId ? '${userModel.first} ${userModel.last}' : 'You',
                                                            fontSize: 12.0,
          ...
          return AnimatedVisibility(
              ...
              child: CircleAvatar(
                ...
                child: IconButton(
                    ...
                    }, icon: const Icon(Icons.keyboard_arrow_down_outlined,color: ConstColor.normalWhite,)),
              ));
        }
    );
  }
  ...
  Future<void> _functionsSendMessage({
    ...
    await ChatFunctions.sendMessageChat(
        ...
        subText: _subText,
        subUser: ref.read(_checkSubTextProv).value != ConstState.firebaseId ? '${userModel.first} ${userModel.last}' : '${myData.first} ${myData.last} '
    ).then((value) async {
      _mainText = '';
      _subText = '';
      _scrollController.jumpTo(0);

      await ConstState.sendMessage(
          id: userModel.id,
          title: "${userModel.first} ${userModel.last}",
          body: _mainText,

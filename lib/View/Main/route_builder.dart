...
import 'package:chatapp/View/Authentications/ForgetAccount/main_reset_screen.dart';
import 'package:chatapp/View/Authentications/Login/main_login_screen.dart';
import 'package:chatapp/View/Authentications/SignUp/main_signup_screen.dart';
import 'package:chatapp/View/Main/tabbar_screen.dart';
import 'package:chatapp/View/Profile/Profile/main_profile_screen.dart';
import 'package:chatapp/View/Profile/ProfileMe/main_profileme_screen.dart';
import 'package:chatapp/View/Test/TestOne.dart';
import 'package:chatapp/View/View/BlockView/main_block_screen.dart';
import 'package:chatapp/View/View/ChatView/main_chat_screen.dart';
import 'package:chatapp/View/View/RequestsView/main_requests_screen.dart';
import 'package:chatapp/View/View/UsersView/main_users_screen.dart';
...
class RouteGenerators {
  ...
  static Route<dynamic>? onGenerate(RouteSettings settings) {
    switch(settings.name) {
      ...
      case routeTest :
        final List<String> _test = settings.arguments as List<String>;
        final String _one = _test.elementAt(0);
        final String _tow = _test.elementAt(1);

        return _cupertinoPageRoute(TestTow(test: _one));
        ...
        case chat :
          ...
          return _cupertinoPageRoute(MainChatScreen(userModel: _userModel));


        case block : return _cupertinoPageRoute(const MainBlockScreen());

        case profile :
          final UserModel _data = settings.arguments as UserModel;
          return _cupertinoPageRoute(MainProfileScreen(userModel: _data));
